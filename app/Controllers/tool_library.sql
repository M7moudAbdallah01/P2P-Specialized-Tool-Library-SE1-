...
INSERT INTO `tools` (`tool_id`, `owner_id`, `category_id`, `tool_name`, `description`, `base_price`, `state`, `availability`, `warranty_expiry_date`, `created_at`) VALUES
(1, 1, 1, 'Drill Machine - Bosch', NULL, 0.00, 'good', 1, NULL, '2026-05-04 08:45:13');
...
(1, 'Ali om', 'ali@example.com', '', 'client', 'basic', 0.00, 'active', NULL),

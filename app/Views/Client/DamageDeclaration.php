...
<body>
            ...
            <div class="damage-page">
                ...
                <div class="declaration-container">
                    ...
                    <div class="form-step active" id="step-1">
                        ...
                        <div class="nav-btns">
                            <span></span>
                            <button class="next-btn" onclick="nextStep(1)">Next <i
                    ...
                    <div class="form-step" id="step-2">
                        ...
                        <div class="nav-btns">
                            <button class="back-btn" onclick="prevStep(2)"><i class="fa fa-arrow-left"></i>
                                Back</button>
                            <button class="next-btn" onclick="nextStep(2)">Next <i
                                    class="fa fa-arrow-right"></i></button>
                        </div>
                    </div>
                    ...
                    <div class="form-step" id="step-3">
                        ...
                        <div class="nav-btns">
                            <button class="back-btn" onclick="prevStep(3)"><i class="fa fa-arrow-left"></i>
                                Back</button>
                            <button class="next-btn" onclick="nextStep(3)">Review <i
                                    class="fa fa-arrow-right"></i></button>
                        </div>
                    </div>
                    ...
                    <div class="form-step" id="step-4">
                        ...
                        <div class="nav-btns">
                            <button class="back-btn" onclick="prevStep(4)"><i class="fa fa-arrow-left"></i>
                                Back</button>
                ...
                <div class="modal-overlay" id="success-modal">
                    <div class="modal-box">
                        ...
                        <p>Your damage declaration has been received. Our team will review it and contact you shortly.
                        </p>
    ...
    <script>// ============================================================
        //  DamageDeclaration.js  —  Multi-step form logic
        // ============================================================
        ...
        function goToStep(to) {
            ...
            steps.forEach((s, i) => {
                const num = i * 2;   // steps are at even indices in the NodeList
            });
        ...
        function validateStep(step) {
            ...
            if (step === 2) {
                ...
                if (!type) {
                    showToast('Please select a damage type.', 'error');
                    return false;
                }
                if (!sev) {
        ...
        function submitReport() {
            ...
            // Generate a fake reference number for demo
            const ref = 'DMG-' + new Date().getFullYear() + '-' + Math.floor(1000 + Math.random() * 9000);
            document.getElementById('modal-ref-id').textContent = ref;
        ...
        function closeModal() {
            ...
            // Optionally redirect: window.location.href = 'dashboard.php';
        }
        ...
        if (dropzone) {
            dropzone.addEventListener('dragover', (e) => {
                e.preventDefault();
                dropzone.style.borderColor = '#ff2e2e';
            });
